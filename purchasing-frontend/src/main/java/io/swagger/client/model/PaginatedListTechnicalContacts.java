...
public class PaginatedListTechnicalContacts {
  ...
  @JsonProperty("items")
  private List<TechnicalContacts> items = null;
  ...
  public PaginatedListTechnicalContacts pageIndex(Integer pageIndex) {
  ...
  **/
  ...
  public PaginatedListTechnicalContacts totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PaginatedListTechnicalContacts pageSize(Integer pageSize) {
  ...
  **/
  ...
  public PaginatedListTechnicalContacts items(List<TechnicalContacts> items) {
    this.items = items;
    return this;
  }

  public PaginatedListTechnicalContacts addItemsItem(TechnicalContacts itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<TechnicalContacts>();
    }
  ...
  **/
  ...
  public List<TechnicalContacts> getItems() {
    return items;
  }

  public void setItems(List<TechnicalContacts> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedListTechnicalContacts paginatedListTechnicalContacts = (PaginatedListTechnicalContacts) o;
    return Objects.equals(this.pageIndex, paginatedListTechnicalContacts.pageIndex) &&
        Objects.equals(this.totalPages, paginatedListTechnicalContacts.totalPages) &&
        Objects.equals(this.pageSize, paginatedListTechnicalContacts.pageSize) &&
        Objects.equals(this.items, paginatedListTechnicalContacts.items) &&
        Objects.equals(this.hasPreviousPage, paginatedListTechnicalContacts.hasPreviousPage) &&
        Objects.equals(this.hasNextPage, paginatedListTechnicalContacts.hasNextPage);
  }
