...
import io.swagger.client.model.KeywordCount;
...
public class PaginatedListKeywordCount {
  ...
  @JsonProperty("items")
  private List<KeywordCount> items = null;
  ...
  public PaginatedListKeywordCount pageIndex(Integer pageIndex) {
  ...
  **/
  ...
  public PaginatedListKeywordCount totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PaginatedListKeywordCount pageSize(Integer pageSize) {
  ...
  **/
  ...
  public PaginatedListKeywordCount items(List<KeywordCount> items) {
    this.items = items;
    return this;
  }

  public PaginatedListKeywordCount addItemsItem(KeywordCount itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<KeywordCount>();
    }
  ...
  **/
  ...
  public List<KeywordCount> getItems() {
    return items;
  }

  public void setItems(List<KeywordCount> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedListKeywordCount paginatedListKeywordCount = (PaginatedListKeywordCount) o;
    return Objects.equals(this.pageIndex, paginatedListKeywordCount.pageIndex) &&
        Objects.equals(this.totalPages, paginatedListKeywordCount.totalPages) &&
        Objects.equals(this.pageSize, paginatedListKeywordCount.pageSize) &&
        Objects.equals(this.items, paginatedListKeywordCount.items) &&
        Objects.equals(this.hasPreviousPage, paginatedListKeywordCount.hasPreviousPage) &&
        Objects.equals(this.hasNextPage, paginatedListKeywordCount.hasNextPage);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedListKeywordCount {\n");
