...
public class PaginatedListFrameworks {
  ...
  @JsonProperty("items")
  private List<Frameworks> items = null;
  ...
  public PaginatedListFrameworks pageIndex(Integer pageIndex) {
  ...
  **/
  ...
  public PaginatedListFrameworks totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PaginatedListFrameworks pageSize(Integer pageSize) {
  ...
  **/
  ...
  public PaginatedListFrameworks items(List<Frameworks> items) {
    this.items = items;
    return this;
  }

  public PaginatedListFrameworks addItemsItem(Frameworks itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Frameworks>();
    }
  ...
  **/
  ...
  public List<Frameworks> getItems() {
    return items;
  }

  public void setItems(List<Frameworks> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedListFrameworks paginatedListFrameworks = (PaginatedListFrameworks) o;
    return Objects.equals(this.pageIndex, paginatedListFrameworks.pageIndex) &&
        Objects.equals(this.totalPages, paginatedListFrameworks.totalPages) &&
        Objects.equals(this.pageSize, paginatedListFrameworks.pageSize) &&
        Objects.equals(this.items, paginatedListFrameworks.items) &&
        Objects.equals(this.hasPreviousPage, paginatedListFrameworks.hasPreviousPage) &&
        Objects.equals(this.hasNextPage, paginatedListFrameworks.hasNextPage);
  }
