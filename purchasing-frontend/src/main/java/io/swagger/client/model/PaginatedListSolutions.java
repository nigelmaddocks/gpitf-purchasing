...
public class PaginatedListSolutions {
  ...
  @JsonProperty("items")
  private List<Solutions> items = null;
  ...
  public PaginatedListSolutions pageIndex(Integer pageIndex) {
  ...
  **/
  ...
  public PaginatedListSolutions totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PaginatedListSolutions pageSize(Integer pageSize) {
  ...
  **/
  ...
  public PaginatedListSolutions items(List<Solutions> items) {
    this.items = items;
    return this;
  }

  public PaginatedListSolutions addItemsItem(Solutions itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Solutions>();
    }
  ...
  **/
  ...
  public List<Solutions> getItems() {
    return items;
  }

  public void setItems(List<Solutions> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedListSolutions paginatedListSolutions = (PaginatedListSolutions) o;
    return Objects.equals(this.pageIndex, paginatedListSolutions.pageIndex) &&
        Objects.equals(this.totalPages, paginatedListSolutions.totalPages) &&
        Objects.equals(this.pageSize, paginatedListSolutions.pageSize) &&
        Objects.equals(this.items, paginatedListSolutions.items) &&
        Objects.equals(this.hasPreviousPage, paginatedListSolutions.hasPreviousPage) &&
        Objects.equals(this.hasNextPage, paginatedListSolutions.hasNextPage);
  }
