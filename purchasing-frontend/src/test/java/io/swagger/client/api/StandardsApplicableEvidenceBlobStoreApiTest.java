...
public class StandardsApplicableEvidenceBlobStoreApiTest {
     ...
     */
    @Test
    public void apiStandardsApplicableEvidenceBlobStoreEnumerateClaimFolderTreeBySolutionIdGetTest() {
        String solutionId = null;
        Integer pageIndex = null;
        Integer pageSize = null;
        PaginatedListClaimBlobInfoMap response = api.apiStandardsApplicableEvidenceBlobStoreEnumerateClaimFolderTreeBySolutionIdGet(solutionId, pageIndex, pageSize);
